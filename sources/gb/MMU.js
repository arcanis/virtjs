define( [
    ...
    MMU.prototype.readUint8 = function ( address ) {
    ...
    MMU.prototype.writeUint8 = function ( address, value ) {
    ...
    MMU.prototype.readUint16 = function ( address ) {
    ...
    MMU.prototype.writeUint16 = function ( address, value ) {
    ...
    MMU.prototype.mapAddress = function ( user, current ) {
    ...
    MMU.prototype._biosMapper = function ( value ) {
