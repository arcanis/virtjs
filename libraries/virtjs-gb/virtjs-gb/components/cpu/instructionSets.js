    ...
    unprefixed : {
        ...
        ADC_r_n : {
            ...
            command : function ADC_r_n( ) {
                ...
                $A[ 0 ] += this.readUint8( );
                var rAfter = $A[ 0 ];
                $A[ 0 ] += engine.environment.cpuCarry;
                var rAfterCarry = $A[ 0 ];
        ...
        AND_rrm : {
            ...
            command : function AND_rrm( ) {
                ...
                engine.environment.a[ 0 ] &= engine.mmu.readUint16( $A[ 0 ] );
        ...
        CP_rrm : {
            ...
            command : function CP_rrm( ) {
                ...
                var a = engine.environment.a[ 0 ];
                var r = engine.mmu.readUint8( $A[ 0 ] );
        ...
        DEC_rrm : {
            ...
            command : function DEC_rrm( ) {
                ...
                var rrmBefore = engine.mmu.readUint8( $A[ 0 ] );
                engine.mmu.writeUint8( $A[ 0 ], rrmBefore - 1 );
                var rrmAfter = engine.mmu.readUint8( $A[ 0 ] );
        ...
        LDH_nm_r : {
            ...
            command : function LDH_nm_r( ) {
                ...
                engine.mmu.writeUint8( 0xFF00 + this.readUint8( ), $A[ 0 ] );
        ...
        LDH_r_nm : {
            ...
            command : function LDH_r_nm( ) {
                ...
                $A[ 0 ] = engine.mmu.readUint8( 0xFF00 + this.readUint8( ) );
        ...
        LD_nnm_r : {
            ...
            command : function LD_nnm_r( ) {
                ...
                engine.mmu.writeUint8( this.readUint16( ), $A[ 0 ] );
        ...
        LD_nnm_rr : {
            ...
            command : function LD_nnm_rr( ) {
                ...
                engine.mmu.writeUint16( this.readUint16( ), $A[ 0 ] );
        ...
        LD_r_nnm : {
            ...
            command : function LD_r_nnm( ) {
                ...
                $A[ 0 ] = engine.mmu.readUint8( this.readUint16( ) );
        ...
        LD_r_rm : {
            ...
            command : function LD_r_rm( ) {
                ...
                $A[ 0 ] = engine.mmu.readUint8( 0xFF00 + $B[ 0 ] );
            ...
            debug : function ( address ) {
                ...
                return {
                    ...
                    label : 'ld ' + [
                        $A.xRegister,
                        '(' + Virtjs.FormatUtil.relativeAddress( 0xFF00, $B.xRegister, 16, 8 ) + ')'
                    ].join( ', ' )
                };
        ...
        LD_rm_r : {
            ...
            command : function LD_rm_r( ) {
                ...
                engine.mmu.writeUint8( 0xFF00 + $A[ 0 ], $B[ 0 ] );
            ...
            debug : function ( address ) {
                ...
                return {
                    size : 1,
                    label : 'ld ' + [
                        '(' + Virtjs.FormatUtil.relativeAddress( 0xFF00, $A.xRegister, 16, 8 ) + ')',
                        $B.xRegister
                    ].join( ', ' )
                };
        ...
        LD_rrm_n : {
            ...
            command : function LD_rrm_n( ) {
                ...
                engine.mmu.writeUint8( $A[ 0 ], this.readUint8( ) );
        ...
        OR_rrm : {
            ...
            command : function OR_rrm( ) {
                ...
                engine.environment.a[ 0 ] |= engine.mmu.readUint8( $A[ 0 ] );
        ...
        RST_n : {
            ...
            debug : function ( address ) {
                ...
                return {
                    size : 1,
                    label : 'rst ' + [
                        Virtjs.FormatUtil.hexadecimal( $A, 8 )
                    ].join( ', ' )
                };
    ...
    cbprefixed : {
        ...
        BIT_n_rrm : {
            ...
            command : function BIT_n_rrm( ) {
                ...
                var value = engine.mmu.readUint8( $B[ 0 ] );
                var test = ( value & ( 1 << $A ) ) === 0;
        ...
        RES_n_rrm : {
            ...
            command : function RES_n_rrm( ) {
                ...
                var newValue = engine.mmu.readUint8( $B[ 0 ] ) & ~ ( 1 << $A );
                engine.mmu.writeUint8( $B[ 0 ], newValue );
        ...
        RLC_r : {
            ...
            command : function RLC_r( ) {
                ...
                var rBefore = $A[ 0 ], leftMostBit = rBefore & 0x80 ? 1 : 0;
                $A[ 0 ] = ( rBefore << 1 ) | ( leftMostBit << 0 );
                var rAfter = $A[ 0 ];
        ...
        RLC_rrm : {
            ...
            command : function RLC_rrm( ) {
                ...
                var rrmBefore = engine.mmu.readUint8( $A[ 0 ] ), leftMostBit = rrmBefore & 0x80 ? 1 : 0;
                engine.mmu.writeUint8( $A[ 0 ], ( rrmBefore << 1 ) | ( leftMostBit << 0 ) );
                var rrmAfter = engine.mmu.readUint8( $A[ 0 ] );
        ...
        RL_rrm : {
            ...
            command : function RL_rrm( ) {
                ...
                var rrmBefore = engine.mmu.readUint8( $A[ 0 ] );
                engine.mmu.writeUint8( $A[ 0 ], ( rrmBefore << 1 ) | ( carry << 0 ) );
                var rrmAfter = engine.mmu.readUint8( $A[ 0 ] );
        ...
        RRC_r : {
            ...
            command : function RRC_r( ) {
                ...
                var rBefore = $A[ 0 ], rightMostBit = rBefore & 0x01 ? 1 : 0;
                $A[ 0 ] = ( rBefore >> 1 ) | ( rightMostBit << 7 );
                var rAfter = $A[ 0 ];
        ...
        RRC_rrm : {
            ...
            command : function RRC_rrm( ) {
                ...
                var rrmBefore = engine.mmu.readUint8( $A[ 0 ] ), rightMostBit = rrmBefore & 0x01 ? 1 : 0;
                engine.mmu.writeUint8( $A[ 0 ], ( rrmBefore >> 1 ) | ( rightMostBit << 7 ) );
                var rrmAfter = engine.mmu.readUint8( $A[ 0 ] );
        ...
        RR_rrm : {
            ...
            command : function RR_rrm( ) {
                ...
                var rrmBefore = engine.mmu.readUint8( $A[ 0 ] );
                engine.mmu.writeUint8( $A[ 0 ], ( carry << 7 ) | ( rrmBefore >> 1 ) );
                var rrmAfter = engine.mmu.readUint8( $A[ 0 ] );
        ...
        SRA_rrm : {
            ...
            command : function SRA_rrm( ) {
                ...
                var rrmBefore = engine.mmu.readUint8( $A[ 0 ] );
                engine.mmu.writeUint8( $A[ 0 ], ( rrmBefore >> 1 ) | ( rrmBefore & 0x80 ) );
                var rrmAfter = engine.mmu.readUint8( $A[ 0 ] );
        ...
        SWAP_rrm : {
            ...
            command : function SWAP_rrm( ) {
                ...
                var rrmBefore = engine.mmu.readUint8( $A[ 0 ] );
                engine.mmu.writeUint8( $A[ 0 ], ( rrmBefore << 4 ) | ( rrmBefore >> 4 ) );
                var rrmAfter = engine.mmu.readUint8( $A[ 0 ] );
